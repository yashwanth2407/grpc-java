...
public final class GreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.grpc.HelloRequest,
      grpc.grpc.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = grpc.grpc.HelloRequest.class,
      responseType = grpc.grpc.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpc.grpc.HelloRequest,
      grpc.grpc.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<grpc.grpc.HelloRequest, grpc.grpc.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<grpc.grpc.HelloRequest, grpc.grpc.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.grpc.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.grpc.HelloReply.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void sayHello(grpc.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<grpc.grpc.HelloReply> responseObserver) {
  ...
  public static final class GreeterStub
     ...
     * </pre>
     */
    public void sayHello(grpc.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<grpc.grpc.HelloReply> responseObserver) {
  ...
  public static final class GreeterBlockingStub
     ...
     * </pre>
     */
    public grpc.grpc.HelloReply sayHello(grpc.grpc.HelloRequest request) {
  ...
  public static final class GreeterFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.grpc.HelloReply> sayHello(
        grpc.grpc.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((grpc.grpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<grpc.grpc.HelloReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              grpc.grpc.HelloRequest,
              grpc.grpc.HelloReply>(
  ...
  private static abstract class GreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return grpc.grpc.Helloworld.getDescriptor();
    }
